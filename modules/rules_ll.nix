...
let
  ...
  processedActionEnvs = map (x: "build --action_env=" + x) config.actionEnv;
  ...
  options = {
    ...
    actionEnv = mkOption {
      ...
      description = lib.mdDoc ''
        Environment variables for the Bazel's `--action_env` argument.
        ...
        ```bash
        build --action_env=CFLAGS=-I''${openssl.dev}/include
        ```
      '';
      default = { };
    };
