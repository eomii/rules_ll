{ pkgs, pkgsUnfree, bazel, unfree }:

# Keep in mind that these strings don't preserve the initial newline. An
# additional empty line is required to separate the lines.
