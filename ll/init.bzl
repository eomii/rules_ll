...
def _initialize_rules_ll_impl(_):
    ...
    http_archive(
        ...
        sha256 = "d67f42c49002486db0bed95e08c00896a1b199417301063eedb65c46372aa1b6",
        strip_prefix = "HIP-02b84f231d463a3da3c8365ec89d4738dd313204",
        urls = [
            "https://github.com/ROCm-Developer-Tools/HIP/archive/02b84f231d463a3da3c8365ec89d4738dd313204.zip",
        ],
    )
    ...
    http_archive(
        ...
        sha256 = "400fb8555d855a76955f7dd41e2caa4df91ef8e75b6389f76e506bead1a945f3",
        strip_prefix = "ROCm-CompilerSupport-79948e1807bca7108722982b9018d61dde9420f2",
        urls = [
            "https://github.com/RadeonOpenCompute/ROCm-CompilerSupport/archive/79948e1807bca7108722982b9018d61dde9420f2.zip",
        ],
        patches = [
