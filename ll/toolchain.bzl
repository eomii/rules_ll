...
def _ll_toolchain_impl(ctx):
    ...
    return [
        platform_common.ToolchainInfo(
            ...
            sycl_headers = ctx.files.sycl_headers,
            sycl_hip_backend = ctx.file.sycl_hip_backend,
            sycl_omp_backend = ctx.file.sycl_omp_backend,
            sycl_plugin = ctx.file.sycl_plugin,
            sycl_runtime = ctx.file.sycl_runtime,
